		...
		for(int i=0; i<5; i++) {
			if(gp.obj[i] != null) {
				 ...
				 case "down":
					 ...
					 if(entity.solidArea.intersects(gp.obj[i].solidArea) && entity.worldY <= gp.obj[i].worldY - gp.obj[i].solidArea.height) {
//						 entity.worldY = gp.obj[i].worldY - 48;
				 ...
				 case "up":
					 entity.solidArea.y += entity.speedY;
					 if(entity.solidArea.intersects(gp.obj[i].solidArea) && entity.worldY >= gp.obj[i].worldY + gp.obj[i].solidArea.height -16) {
//						 entity.worldY = gp.obj[i].worldY - 48;
						 entity.speedY = 1;
